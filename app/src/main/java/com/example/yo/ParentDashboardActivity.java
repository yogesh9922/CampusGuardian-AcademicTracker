...
public class ParentDashboardActivity extends AppCompatActivity {
    ...
    private TextView parentViewingBanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            studentId = getIntent().getStringExtra("linkedStudentId");
            ...
            Log.e("ParentDashboard", "Firebase initialization error: " + e.getMessage());
    ...
    private void initializeUIElements() {
        parentViewingBanner = findViewById(R.id.parentViewingBanner);
    ...
    private void loadStudentData() {
        Log.d("ParentDashboard", "Loading student data for ID: " + studentId);
        databaseReference.child("students").child(studentId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot studentSnapshot) {
                if (!studentSnapshot.exists()) {
                    Toast.makeText(ParentDashboardActivity.this, "Student data not found", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (dept != null) studentDept.setText(dept);
                    if (year != null) studentYear.setText(year);
                    if (roll != null) studentRoll.setText(roll);
                    if (cgpa != null) studentCgpa.setText(cgpa);
                    if (name != null) welcomeText.setText("Viewing: " + name);
                    ...
                    if (backlogsSnapshot.exists()) {
                        ...
                        backlogCount.setText(String.valueOf(count) + " Backlogs");
                        backlogSubjects.setText(subjects.toString());
                    } else {
                        backlogCount.setText("0 Backlogs");
                    ...
                    if (marksSnapshot.exists()) {
                        ...
                        for (DataSnapshot subj : marksSnapshot.getChildren()) {
                            ...
                            TextView marksView = new TextView(ParentDashboardActivity.this);
                    ...
                    if (cgpaSnapshot.exists()) {
                        ...
                        for (DataSnapshot sem : cgpaSnapshot.getChildren()) {
                            ...
                            TextView cgpaView = new TextView(ParentDashboardActivity.this);
                    ...
                    Log.e("ParentDashboard", "Error loading student data: " + e.getMessage());
                    Toast.makeText(ParentDashboardActivity.this, "Error loading data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    loadingSpinner.setVisibility(View.GONE);
                    retryButton.setVisibility(View.VISIBLE);
                    refreshFab.setVisibility(View.GONE);
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Log.e("ParentDashboard", "Firebase error: " + error.getMessage());
                Toast.makeText(ParentDashboardActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                loadingSpinner.setVisibility(View.GONE);
                retryButton.setVisibility(View.VISIBLE);
                refreshFab.setVisibility(View.GONE);
            }
